...
SET SERVEROUT ON ECHO OFF FEED OFF VER OFF TAB OFF LINES 500;
 
COL report_date NEW_V report_date;
SELECT TO_CHAR(SYSDATE, 'YYYY_MM_DD') report_date FROM DUAL;
SPOOL indexes_2b_shrunk_&&report_date..txt;
...
l_percent NUMBER;
BEGIN
DBMS_OUTPUT.PUT_LINE('DB_NAME: '||SYS_CONTEXT('USERENV', 'CON_NAME'));
